...
function SystemOverview({onBack,onNext,reset}:{onBack:()=>void;onNext:()=>void;reset:()=>void}) {
  ...
  return <main className="entry overview-screen"><Logo reset={reset}/><section className="system-overview screen-reveal"><header><div><span>SYSTEM DEFINITION</span><h2>SYSTEM SCHEMATIC</h2></div><small>INTRODUCTION · 00 / 04</small></header>
    <div className="system-scene" aria-label="SALDDP 시스템 구성도">
      ...
      {activeDetail===2&&<aside className="ld-mini-schematic" aria-label="LD 제습 및 재생 내부 물질·열 흐름"><button type="button" className="ld-mini-close" aria-label="LD 상세 스케메틱 닫기" onClick={(event)=>{event.stopPropagation();setActiveDetail(0);}}>×</button><header><span>LIQUID DESICCANT MASS &amp; HEAT FLOW</span><b>LD 내부 물질·열교환</b><small>공기와 LiCl 용액 사이의 수분 이동, 재생열 공급 방향</small></header><svg viewBox="0 0 520 270" role="img" aria-label="제습부에서 외기 수분을 LiCl 용액이 흡수하고 재생부에서 태양열과 축열조 열로 수분을 배출하는 과정"><defs><marker id="ldArrowYellow" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0 0L8 4L0 8Z" fill="#ffd24c"/></marker><marker id="ldArrowCyan" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0 0L8 4L0 8Z" fill="#4ee7f0"/></marker><marker id="ldArrowGreen" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0 0L8 4L0 8Z" fill="#9ee678"/></marker><marker id="ldArrowBlue" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0 0L8 4L0 8Z" fill="#4e9cff"/></marker><marker id="ldArrowRed" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0 0L8 4L0 8Z" fill="#ff6d64"/></marker></defs>
        <g className="ld-unit absorber"><rect x="92" y="55" width="126" height="126" rx="12"/><text className="unit-title" x="155" y="80">ABSORBER</text><text className="unit-sub" x="155" y="100">제습부</text><path className="packing" d="M112 116H198M112 131H198M112 146H198"/></g>
